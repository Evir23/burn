...
def run_detection(model_path, source, num_iterations=5):
    ...
    # Проверяем, что источник — это изображение
    if source.endswith(('.jpg', '.jpeg', '.png')):
        ...
        print("Для данного скрипта поддерживаются только изображения.")
...
if __name__ == "__main__":
    ...
    parser.add_argument('source', type=str, help='Путь к изображению')
